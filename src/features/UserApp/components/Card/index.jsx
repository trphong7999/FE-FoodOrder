...
export default function Card({merchant, index, key}) {
    const {marchantID, merchantImg, merchantName, merchantLocation} = merchant;
    return (
        <div className="col l-2">
            <Link to="/nemnuongnhatrang" className="dish-link">
                <div className="dish-item">
                    ...
                    <div className="dish-info">
                        ...
                        <div className="dish-location">
                            <img src={iconDiscount} alt="icon-discount" className="dish-img__discount"/>
