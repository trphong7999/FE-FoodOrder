    ...
    return (
        <div className="footer-wrap">
            <div className="grid wide">
                <div className="row">
                    <section className="footer-item col l-4">
                        <img src={logo} alt="logo" className="footer-logo"/>
                        <p className="name-company">Công ty TNHH H2P Việt Nam</p>
                        <p className="location-company">484 Lạch Tray - Đổng Quốc Bình - Lê Chân - TP. Hải Phòng</p>
                        <p className="email-company">Email: foodlovers.h2p@gmail.com</p>
                        <p className="hotline-company">Hotline: 1900.999.999</p>
                    </section>
                    <section className="footer-item col l-2">
                        <h3 className="footer-title">Dịch vụ</h3>
                        <Link to="/" className="footer-link">FoodShip - giao đồ ăn</Link>  
                        <Link to="/" className="footer-link">FoodShip - giao đồ ăn</Link>
                        <Link to="/" className="footer-link">FoodShip - giao đồ ăn</Link>
                        <Link to="/" className="footer-link">FoodShip - giao đồ ăn</Link>                
                    </section>
                    <section className="footer-item col l-2">
                        ...
                        <Link to="/" className="footer-link">FoodLovers - Hải Phòng</Link>
                        <Link to="/" className="footer-link">FoodLovers - Hải Phòng</Link>
                        <Link to="/" className="footer-link">FoodLovers - Hải Phòng</Link>
                        <Link to="/" className="footer-link">FoodLovers - Hải Phòng</Link>
                    </section>
                    <section className="footer-item col l-2">
                        ...
                        <Link to="/" className="footer-link">Giới thiệu về FoodLovers</Link>
                        <Link to="/" className="footer-link">Giới thiệu về FoodLovers</Link>
                        <Link to="/" className="footer-link">Giới thiệu về FoodLovers</Link>
                        <Link to="/" className="footer-link">Giới thiệu về FoodLovers</Link>
                    </section>
                    <section className="footer-item col l-2">
                        ...
                        <Link to="/" className="footer-link icon">
                            <SiInstagram className="footer-icon"/>Instagram
                        </Link>
                    </section>
                </div>
